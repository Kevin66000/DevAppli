    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="nav navbar-nav ml-auto">
          ...
          if (isset($_SESSION['idUser']) && ($unutilisateur->GetRole()->GetPermission()['voirparc'] || $unutilisateur->GetRole()->GetPermission()['modifierparc'])) {
            ?>
          ...
          //test si l'utilisateur a la permition
          if (isset($_SESSION['idUser']) && ($unutilisateur->GetRole()->GetPermission()['voircomposant'] || $unutilisateur->GetRole()->GetPermission()['voirtouscomposants'])) {
            ?>
          ...
          if (isset($_SESSION['idUser']) && (($unutilisateur->GetRole()->GetPermission()['voirtickets'] || $unutilisateur->GetRole()->GetPermission()['voirtouslestickets']) || $unutilisateur->GetRole()->GetPermission()['voirnotes'])) {
            ?>
            <li class="dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Assistance</a>
              <div class="dropdown-menu" role="menu">
                <?php
                //test si l'utilisateur a la permition
                if (isset($_SESSION['idUser']) && ($unutilisateur->GetRole()->GetPermission()['voirtickets'] || $unutilisateur->GetRole()->GetPermission()['voirtouslestickets'])) {
                  ?>
                  <a class="dropdown-item" role="presentation" href="/ticket.php">Tickets</a>
                  <?php
                }
                if (isset($_SESSION['idUser']) && ($unutilisateur->GetRole()->GetPermission()['voirnotes'])) {
                  ?>
          ...
          //test si l'utilisateur a le drois a au moins une permition
          if (isset($_SESSION['idUser']) && ($unutilisateur->GetRole()->GetPermission()['gererutilisateurs'] || $unutilisateur->GetRole()->GetPermission()['gererroles'])) {
            ?>
            <li class="dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Administration</a>
              <div class="dropdown-menu" role="menu">
                <?php
                //test si l'utilisateur a la permition
                if (isset($_SESSION['idUser']) && ($unutilisateur->GetRole()->GetPermission()['gererutilisateurs'])) {
                  ?>
                ...
                //test si l'utilisateur a la permition
                if (isset($_SESSION['idUser']) && ($unutilisateur->GetRole()->GetPermission()['gererroles'])) {
                  ?>
